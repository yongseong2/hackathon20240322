...
export type ChatComponentProps<P, T extends ElementTypeOrHTMLElement> = P &
  (T extends ElementType
    ? Omit<ComponentPropsWithoutRef<T>, 'children' | keyof P>
    : Omit<HTMLAttributes<T>, 'children' | keyof P>);

export type ChatComponentPropsRef<P, T extends ElementTypeOrHTMLElement> = P &
  (T extends ElementType
    ? Omit<ComponentPropsWithRef<T>, 'children' | keyof P>
    : Omit<DetailedHTMLProps<HTMLAttributes<T>, T>, 'children' | keyof P>);

export type ChatComponentPropsChildren<
  P,
  T extends ElementTypeOrHTMLElement
> = PropsWithChildren<ChatComponentProps<P, T>>;

export type ChatComponentPropsChildrenRef<
  P,
  T extends ElementTypeOrHTMLElement
> = PropsWithChildren<ChatComponentPropsRef<P, T>>;
